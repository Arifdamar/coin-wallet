...
const Sidebar: FunctionComponent<Props> = ({ selectedTab }) => {
  return (
    <div className="flex flex-row md:flex-col items-center md:py-8 md:gap-6 bg-white px-4 md:px-0 border-b-2 w-full md:w-1/4 md:justify-start xl:w-1/6 justify-between h-1/6 md:h-full border-gray-200 md:border-r-2">
      ...
      <div className="flex items-center">
        ...
        <p className="text-astronaut-800 font-bold text-xl whitespace-nowrap">
          Coin Wallet
        </p>
      </div>
      <div className="flex flex-col gap-2 items-center">
        ...
        />
        <p className="hidden md:flex text-astronaut-700 font-bold text-lg whitespace-nowrap">
          Arif Çağrı DAYİR
        </p>
      </div>
      <div
